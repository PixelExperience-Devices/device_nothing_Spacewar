...
package org.pixelexperience.glyph.Tiles;
...
public class TileActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (sourceClass.getClassName().equals("org.pixelexperience.glyph.Tiles.GlyphTileService")
            || sourceClass.getClassName().equals("org.pixelexperience.glyph.Tiles.TorchTileService")) {
